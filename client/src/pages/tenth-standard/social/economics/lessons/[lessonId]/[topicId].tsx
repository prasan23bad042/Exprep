    ...
    return (
      <div className="container mx-auto p-8">
        <Button asChild variant="ghost" className="mb-6">
          <Link href="/tenth-standard/social/economics">
              ...
              <div className="mt-8 pt-4 border-t flex justify-between">
                {previousTopic ? (
                  <Button asChild variant="outline">
                    <Link href={`/tenth-standard/social/economics/lessons/${previousUnitId}/${previousTopic.id}`}>
                ...
                {nextTopic ? (
                  <Button asChild>
                    <Link href={`/tenth-standard/social/economics/lessons/${nextUnitId}/${nextTopic.id}`}>
                      {nextTopic.title}
