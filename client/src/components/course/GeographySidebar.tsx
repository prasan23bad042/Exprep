...
interface GeographySidebarProps {
  currentLessonId?: string;
  currentTopicId?: string;
}

export default function GeographySidebar({ currentLessonId, currentTopicId }: GeographySidebarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-b relative">
        {!isCollapsed ? (
          <h2 className="text-lg font-semibold">Geography Content</h2>
        ) : (
          <div className="h-6 flex items-center justify-center">
            <span className="text-xl font-bold text-primary">GE</span>
          </div>
        )}
        <button
