"""
Script to extract English content and separate Prose, Poem, and Supplementary into individual topics
"""
...
# Save to JSON file
with open('d:/Exprep/english_units_separated.json', 'w', encoding='utf-8') as f:
    json.dump(all_units_data, f, ensure_ascii=False, indent=2)

print('✅ All units processed! Content saved to english_units_separated.json')
